...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State
        \State $r \gets$ \Call{Squeeze}{$32$} $\modl$\label{alg:veil.sres-encrypt-challenge}
        ...
        \EndFunction
    \end{algorithmic}\label{alg:veil.sres-encrypt}
\end{algorithm}
...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \EndIf
        \EndFunction
    \end{algorithmic}\label{alg:veil.sres-decrypt}
\end{algorithm}
