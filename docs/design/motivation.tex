...
SHA2-256, SHA2-384, SHA2-512, SHA2-224. For public key encryption, it's supported RSA, %chktex 8 
ElGamal, Diffie-Hellman, and ECDH, all with different parameters. For digital signatures, it's
supported RSA, DSA, ElGamal, ECDSA, and EdDSA, again, all with different parameters.
