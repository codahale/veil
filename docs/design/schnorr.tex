...
Unlike Construction 13.12 of~\textcite[p. 482]{katz2020}, \texttt{veil.schnorr} transmits the commitment point $I$ as
part of the signature and the verifier calculates $I'$ vs transmitting the challenge scalar $r$ and calculating $r'$.
In this way, \texttt{veil.schnorr} is closer to EdDSA~\cite{brendel2021} or the Schnorr variant proposed by
Hamburg~\cite{hamburg2017}.
...
Per Theorem 13.10 of~\textcite[p. 478]{katz2020}, this construction is UF-CMA secure if the Schnorr identification
