...
Veil uses the Cyclist construction parameterized with $f$=Keccak-\emph{f}[1600,12], $R_\text{hash}$=1088,
$R_\text{kin}$=800, $R_\text{kout}$=1536, and $\ell_\text{ratchet}$=256.
