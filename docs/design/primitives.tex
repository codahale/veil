...
The resulting construction targets a 128-bit security level and is $~4x$ faster than SHA-256, $~5x$ faster than
ChaCha20Poly1305, and $~7.5x$ faster than AES-128-GCM in software.
