...
standard Cyclist authenticated encryption scheme.
Argon2 increases the cost for an attacker to mount a brute-force or dictionary attack using highly
parallel hardware \@(e.g.\ GPUs, ASICs) by increasing the per-core memory requirements for attempts.
