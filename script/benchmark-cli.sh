...
./target/release/veil-control private-key /tmp/private-key-control --passphrase-file=README.md --m-cost=8 --t-cost=1 --p-cost=1
./target/release/veil-experiment private-key /tmp/private-key-experiment --passphrase-file=README.md --m-cost=8 --t-cost=1 --p-cost=1
